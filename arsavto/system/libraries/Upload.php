...
class CI_Upload {
	...
	// Is $_FILES[$field] set? If not, no reason to continue.
		...
		if ( ! $this->is_allowed_dimensions_max())
		{
			$this->set_error('upload_invalid_dimensions_max');
			return FALSE;
		}
	 ...
	 * @return	bool
	 */
	public function is_allowed_dimensions_max()
	{
		if ( ! $this->is_image())
		{
			return TRUE;
...
echo $D['0']." ".$this->min_width." ".$D['1']." ".$this->min_height;
			return TRUE;
		}
			echo 3;
		return TRUE;
